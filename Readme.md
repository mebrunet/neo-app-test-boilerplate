...
from **Y**et **A**nother **R**eact **S**tarter **K**it.

The goal of this project is to builda 99.5% coverage mobile app for NeoHome.
The front-end stack will be: React, Alt and Bootstrap.
